...
num_iterations = 250; % number of total iterations
delta1 = 0.00005;
step_size = 0.005;% Step size for BCD ZORO
step_size2 = 0.005;% Steop size for normal ZORO
x0 = randn(D,1);
...
tol = 5e-8;%5e-2;
[f_hat_COSAMP,x_hat_COSAMP,regret_COSAMP,time_vec_COSAMP,gradient_norm] = ZerothOrderGD_CoSampP4(J*num_iterations,step_size,x0,true_min,S,D,noise_level,num_samples, delta1,init_grad_estimate,tol,J);
