function [I_attack,label,iter,l2norm] = ZerothOrderGD_CoSamp(num_iterations,step_size,x0,D,num_samples,sparsity,tol,I,true_id,net,true_label,level)
...
epsilon = 0.5;% parameter for the box constraint
...
for j = 1:num_iterations
    %disp(j);
    %delta = 0.0005 * norm(grad_estimate);
